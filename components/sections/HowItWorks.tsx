        ...
        <section className="bg-white/5 py-10 mb-44">
            <SectionWrapper>
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex justify-between gap-10 mt-10">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-2xl text-white w-5/6 text-center">Free call/chat</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-2xl text-white w-5/6 text-center">Compile your information</p>
                        </div>
			 ...
			 M7,15H5v-2h2V15z"/>
                            ...
                            <p className="text-2xl text-white w-5/6 text-center">Create a clear plan</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-2xl text-white w-5/6 text-center">Live with confidence</p>

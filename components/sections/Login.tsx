...
const Login = () => {
    return ( 
        ...
        <div className="w-1/2 px-10 py-10">
            <h1 className="text-[#Cf1259] font-bold text-4xl  py-5">App~Name</h1>            <Link className="text-[#Cf1259] font-bold text-4xl  py-5" href="#">App~Name</Link>
        ...
        <div className="bg-white h-screen w-1/2 py-20 gap-5 flex flex-col items-center ">
            ...
            <form className="flex flex-col gap-4 w-3/5">
                ...
                <Button text={"Sign in"} className="w-[10rem]" />
